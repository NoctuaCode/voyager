...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    ...
    KC_AT,            MT(MOD_LGUI, KC_SCLN),               MT(MOD_LALT, KC_COMMA),              MT(MOD_LCTL, KC_DOT),                MT(MOD_LSFT, KC_P),                  KC_Y,                                           KC_F,                    MT(MOD_RSFT, KC_G),                  MT(MOD_RCTL, KC_C),                  MT(MOD_LALT, KC_R),                  MT(MOD_RGUI, KC_L),                  KC_SLASH,
